...
/**
 * This is created to perform JSR 303 validation.
 *  
 * Based on the SO http://stackoverflow.com/questions/25220440/can-jsr-303-bean-validation-be-used-with-spring-data-rest
 * 
 * @author sbelida
 */
@ControllerAdvice
...
{	
    ...
    public @ResponseBody List<ConstraintViolationModel> handleConstraintViolation(HttpServletRequest req, final ConstraintViolationException exception) 
   {
